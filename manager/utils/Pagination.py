...
# {{ page_string }}
# </ul>
# <form action="" method="get" style="float: right;margin-top: 20px;margin-right: 350px" class="clearfix">
...
class Pagination(object):
    ...
    def html(self):
        ...
        # 跳到首页
        self.query_dict.setlist(self.page_param, [1])
        self.head_page = '<li><a href="?{}" aria-label="Previous"><span aria-hidden="true">首页</span></a></li>'.format(
        ...
        # 跳到尾页
        self.query_dict.setlist(self.page_param, [self.total_page_count])
        self.end_page = '<li><a href="?{}" aria-label="Next"><span aria-hidden="true">尾页</span></a></li>'.format(
            self.query_dict.urlencode())
